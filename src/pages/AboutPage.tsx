      ...
      <div className="container mx-auto py-6 px-4 max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          <Card className="text-center p-6 hover:shadow-lg transition-shadow">
            <CardHeader>
              ...
              <CardTitle className="text-xl">{missionSection?.title || 'Our Mission'}</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="text-center p-6 hover:shadow-lg transition-shadow">
            <CardHeader>
              ...
              <CardTitle className="text-xl">{visionSection?.title || 'Our Vision'}</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600 leading-relaxed">
          ...
          <Card className="text-center p-6 hover:shadow-lg transition-shadow">
            <CardHeader>
              ...
              <CardTitle className="text-xl">{valuesSection?.title || 'Our Values'}</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600 leading-relaxed">
        ...
        {privacySection && (
          <Card className="bg-gray-50">
            <CardHeader>
              <CardTitle className="text-2xl text-center">{privacySection.title}</CardTitle>
            </CardHeader>
            <CardContent>
